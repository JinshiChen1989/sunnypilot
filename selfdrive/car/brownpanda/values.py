...
from openpilot.selfdrive.car import CarSpecs, PlatformConfig, Platforms, dbc_dict, AngleRateLimit
from openpilot.common.conversions import Conversions as CV
from openpilot.selfdrive.car.docs_definitions import CarDocs, CarParts, CarHarness
...
DBC = {
  CAR.BYD_ATTO3: dbc_dict('brownpanda', None),      # Single bus architecture
  CAR.DEEPAL_S05: dbc_dict('brownpanda', None),     # Single bus architecture
  CAR.BYD_DOLPHIN: dbc_dict('brownpanda', None),    # Single bus architecture
}

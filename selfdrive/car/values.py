...
from openpilot.selfdrive.car.brownpanda.values import CAR as BROWNPANDA

Platform = BODY | CHRYSLER | BROWNPANDA | FORD | GM | HONDA | HYUNDAI | MAZDA | NISSAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN

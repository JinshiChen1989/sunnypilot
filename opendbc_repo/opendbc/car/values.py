...
from opendbc.car.brownpanda.values import CAR as BROWNPANDA
...
Platform = BODY | BROWNPANDA | CHRYSLER | FORD | GM | HONDA | HYUNDAI | MAZDA | MOCK | NISSAN | PSA | RIVIAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN
